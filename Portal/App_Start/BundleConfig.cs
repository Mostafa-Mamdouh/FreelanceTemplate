...
namespace Web
{
    public static class BundleConfig
    {
        ...
        {
            bundles.Add(new StyleBundle("content/SmartAdmin/smartadmin").IncludeDirectory("content/SmartAdmin/css", "*.min.css"));
            ...
            bundles.Add(new ScriptBundle("~/scripts/plugin/easy-pie-chart/jquery.easy-pie-chart.min").Include(
